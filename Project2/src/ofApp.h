...
class ofApp : public ofBaseApp{
	...
	public:
		...
		bool shootingTheme = true;

		ParticleEmitter explosionsEmitter;
		ParticleEmitter particleRay;

		ofSoundPlayer   explosions, collisions, movement;
};
